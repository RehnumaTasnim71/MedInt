...
public class AddUserGui {
   ...
   public AddUserGui(){
		...
		this.AdduserFrame.setLayout(null);
		 ...
		 try {
            AdduserFrame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("D://resources//test.jpg")))));
        } 
		catch (IOException e) {
            e.printStackTrace();
        }
			...
			try
					{
						...
						String query="insert into admin(id,username,password) values ('"+userIdTextField.getText()+"','"+userNameTextField.getText()+"','"+Pass+"')";
