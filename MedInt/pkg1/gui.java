...
public class gui 
{
	...
	public void mainGui()
	{
		 ...
		 try {
            frame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("D://resources//test7.jpg")))));
        } 
		catch (IOException e) {
            e.printStackTrace();
        }
			...
			public void actionPerformed(ActionEvent arg0) 
				{
					try
					{
						...
						String query="insert into medint (id,name,quantity,price) values ('"+txt_ProductId_update.getText()+"','"+txt_Name_update.getText()+"','"+txt_Quantity_update.getText()+"',"+txt_Price_update.getText()+")";
